...
public class WrapperClassMethods {
    public static void main(String[] args) {
        ...
        boolean r1 = Boolean.parseBoolean(x); //returns  primitive type , converts string to primitive values

        Boolean r2 = Boolean.valueOf(x); // returns wrapper class objects , converts string to wrapper values
